...
**Measured against**: `docs/archive/init_convo/ui-framework-spec.md` (goals + paradigm analysis) and `docs/archive/init_convo/ui-framework-refinement.md` (the "three walls of pure TEA" escape hatches).
